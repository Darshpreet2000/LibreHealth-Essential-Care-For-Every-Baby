...
import 'package:newborn_care/network/summary_api_client.dart' as _i4;
import 'package:newborn_care/repository/hive_storage_repository.dart' as _i3;
import 'package:newborn_care/repository/summary_repository.dart' as _i7;
...
class _FakeSummaryApiClient extends _i1.Fake implements _i4.SummaryApiClient {}
...
class MockSummaryRepository extends _i1.Mock implements _i7.SummaryRepository {
  ...
  set hiveStorageRepository(
      ...
      super.noSuchMethod(
          ...
          returnValueForMissingStub: null);
  @override
  _i4.SummaryApiClient get summaryApiClient =>
      (super.noSuchMethod(Invocation.getter(#summaryApiClient),
          returnValue: _FakeSummaryApiClient()) as _i4.SummaryApiClient);
  @override
  set summaryApiClient(_i4.SummaryApiClient? _summaryApiClient) => super
      .noSuchMethod(Invocation.setter(#summaryApiClient, _summaryApiClient),
          returnValueForMissingStub: null);
  @override
  _i8.Future<dynamic> fetchSummaryOf24Hours() =>
